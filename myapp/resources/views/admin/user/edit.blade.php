    ...
    <div class="container">
        ...
        <form action="{{ route('user.update',  $user ->id) }}" method="POST">
            ...
            <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" value="{{ $user->name}}"  name="name" placeholder="Input field"/>
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ $user->email}}" name="email" placeholder="Input field"/>
                @error('email')
                <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
